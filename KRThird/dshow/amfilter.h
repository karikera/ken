...
public:
    ...
    virtual LPAMOVIESETUP_FILTER GetSetupData(){ return nullptr; }
...
public:
    ...
    // apPin can be nullptr if nPin==0 (not otherwise).
    ...
    BOOL IsConnected(void) {return (m_Connected != nullptr); };
...
protected:
    ...
    // can be canceled by calling IPinFlowControl2::Block( 0, nullptr )
                       ...
                       public CCritSec             // Provides object locking
{
    ...
    {
    public:
        CSampleList() : m_List(nullptr), m_nOnList(0) {};
#ifdef DEBUG
        ~CSampleList()
        {
            ASSERT(m_nOnList == 0);
...
public:
    ...
    // optional and either may be nullptr, they may alternatively be set to
