...
b. Make a static CreateInstance function that takes an LPUNKNOWN, an HRESULT *
   ...
   In retail builds NAME(_x_) compiles to nullptr, the base CBaseObject class
...
/*  A function (can be nullptr) which is called from the DLL entrypoint
