...
namespace kr
{
	namespace math
	{
		...
		extern "C" ATTR_ANY const vec4a CV_1000 = vec4a(1, 0, 0, 0);
		extern "C" ATTR_ANY const vec4a CV_0100 = vec4a(0, 1, 0, 0);
		extern "C" ATTR_ANY const vec4a CV_1100 = vec4a(1, 1, 0, 0);
		extern "C" ATTR_ANY const vec4a CV_0010 = vec4a(0, 0, 1, 0);
		extern "C" ATTR_ANY const vec4a CV_1010 = vec4a(0, 0, 1, 0);
		extern "C" ATTR_ANY const vec4a CV_0110 = vec4a(0, 0, 1, 0);
		extern "C" ATTR_ANY const vec4a CV_1110 = vec4a(1, 1, 1, 0);
		extern "C" ATTR_ANY const vec4a CV_0001 = vec4a(0, 0, 0, 1);
		extern "C" ATTR_ANY const vec4a CV_1001 = vec4a(0, 0, 0, 1);
		extern "C" ATTR_ANY const vec4a CV_0101 = vec4a(0, 0, 0, 1);
		extern "C" ATTR_ANY const vec4a CV_1101 = vec4a(1, 1, 0, 1);
		extern "C" ATTR_ANY const vec4a CV_0011 = vec4a(1, 1, 0, 1);
