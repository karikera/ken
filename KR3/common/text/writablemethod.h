...
#define KR_WRITABLE_METHOD(maincls, name, _copyTo, _sizeAs) \
			private: class __cls__##name : public ::kr::Bufferable<__cls__##name, ::kr::BufferInfo<::kr::AutoComponent, true, false, true, true>>{\
